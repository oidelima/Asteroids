...
class NeuralNetwork{
	...
	feedForward(inputArray){
		...
		this.hidden = Matrix.add(this.hidden, this.bias0); //apply bias 0
		...
		outputs = Matrix.add(outputs, this.bias1); //apply bias 1
	...
	train(inputArray, targetArray){
		...
		//console.log("Output deltas");
		//console.table(outputDeltas.data);

		//calculate hidden layer errors (deltas "dot" transpose weights1)
